<template>
    <div class="p-4">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-2xl font-Medium">退款管理</h2>
...
import api from '@/api/admin/refunds'
...
const handleSearch = async () => {
    loading.value = true
    // TODO: 实现搜索逻辑
    api.getRefunds({ ...searchForm.value, page: currentPage.value, limit: pageSize.value }).then(res => {
