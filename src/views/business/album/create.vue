            ...
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="90px" label-position="right"
                ...
                <div class="form-col">
                    <el-form-item label="专辑名" prop="name">
                        <el-input v-model="ruleForm.name" placeholder="请输入专辑名" clearable />
                    </el-form-item>
...
const submitRole = () => {
    ruleFormRef.value?.validate(async (valid) => {
        ...
        const api = data.id ? combine_albumsApi.put : combine_albumsApi.create
        try {
...
onMounted(async () => {
    ...
    if (id) {
        const res = await combine_albumsApi.detail(id)
