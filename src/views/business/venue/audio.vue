...
const venue_id = computed(() => route.query.venue_id as string);
...
function submitRole() {
    ruleFormRef.value?.validate(async (valid) => {
        ...
        const data: any = { venue_id: venue_id.value, ...ruleForm };
        ...
        const api = data.id ? venue_introductionsApi.put : venue_introductionsApi.create;
...
onMounted(async () => {
    ...
    if (id) {
        const res = await venue_introductionsApi.detail(id)
