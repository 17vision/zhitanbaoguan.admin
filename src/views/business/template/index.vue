  ...
  <div v-loading="$store.loading" class="p-5">
    ...
    <div class="bg-white rounded-lg shadow-md p-4">
      ...
      <el-table
        ...
        :header-cell-style="{ background: '#F5F6FA', color: '#666' }"
        class="w-full"
      >
        ...
        <el-table-column label="介绍" prop="introduction">
          <template #default="scope">
            <div
              class="line-clamp-3 text-gray-500 text-xs"
        ...
        <el-table-column label="操作" align="center" fixed="right" width="180">
          <template #default="scope">
            <div class="flex gap-4 items-center justify-center">
              <!-- 上下线 -->
              <el-button
                v-if="includes(app.routeNames, ['template.update'])"
                link
                size="small"
              ...
              <el-dropdown @command="handleCommand($event, scope.row)">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item
                      v-if="includes(app.routeNames, ['template.delete'])"
                      command="delete"
                      divided
                      >删除
                    </el-dropdown-item>
...
const goPublish = async (row: { id: string; status: number }) => {
  ...
  // 确认弹窗
  await ElMessageBox.confirm(`确定要将该记录${actionText}吗？`, '操作确认', {
