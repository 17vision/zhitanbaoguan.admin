        ...
        <el-card v-loading="$store.loading" shadow="never" class="form-card">
            ...
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="110px" label-position="right"
                ...
                <el-form-item label="组织名称" prop="name">
                    <el-input v-model="ruleForm.name" placeholder="请输入组织名称" clearable style="width: 400px" />
                </el-form-item>

                <el-form-item label="联系手机" prop="phone">
                    <el-input v-model="ruleForm.phone" placeholder="请输入手机号" clearable style="width: 400px" />
                </el-form-item>

                <el-form-item label="组织介绍" prop="introduction">
                    <el-input v-model="ruleForm.introduction" type="textarea" :rows="8" placeholder="请输入组织介绍" clearable
                        style="width: 400px" />
                </el-form-item>
