                ...
                <el-dialog v-model="dialog.visible" :title="dialog.title" :show-close="false" :destroy-on-close="true"
                    ...
                    <el-form label-width="80px">
                        ...
                        <el-form-item label="描述">
                            <el-input v-model="dialog.description" type="textarea" placeholder="请输入分组描述" maxlength="12"
                                clearable />
                        </el-form-item>
                    </el-form>
                    <template #footer>
...
import api from '@/api/admin/scene_categories'
...
function fetchMediaGroups() {
    api.list({ limit: 100 }).then((res: Record<string, any>) => {
        groups.value = res.data as Tree[]
    })
}
